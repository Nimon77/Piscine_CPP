...
/*   Updated: 2021/03/13 02:25:08 by nsimon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main() {
	...
	ClapTrap clap1(0, 0, 0, 0, 0, "clap1", 0, 0, 0);
	...
	std::cout << std::endl;
	std::cout << SURCYAN << "---------------------" << RESET
		<< GREEN << " SuperTrap " << RESET << SURCYAN
		<< "---------------------" << RESET << std::endl;
	SuperTrap super2("super2");

	super2.vaulthunter_dot_exe("unknown");
	super2.ninjaShoebox(scav2);
	super2.rangedAttack("test");
	super2.meleeAttack("test");
	super2.ninjaShoebox(scav2);
	super2.vaulthunter_dot_exe("test");
	super2.ninjaShoebox(scav2);
	super2.vaulthunter_dot_exe("test");
